				...
				<div class="user">
					...
					<div class="user-info">
						<a data-toggle="collapse" href="#collapseExample" class="username">
							<span> <b><%=user.getFirstName()%> <%=user.getLastName()%></b>
								<b class="caret"> </b>
						</span>
						</a>
					...
					<div class="navbar-wrapper">
						...
						<div class="navbar-minimize">
							...
							<div class="collapse navbar-collapse justify-content-end">
								<h2 style="margin-left: 300px; color: purple" class="card-title">Admin - Library
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header card-header-rose card-header-icon">
									...
									<h5><a style="margin-left: 800px;" href="add_book.jsp">Add Book</a></h5>
								</div>
								<div class="card-body">
											...
											<tbody>
												...
												<tr>
													...
													<td class="td-actions text-right"><a
														href="ManageBookServlet?book=<%=books.getIsbn()%>">
														Delete Book</a></td>
