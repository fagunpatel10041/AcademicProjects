...
<%@page import="Beans.IssuedBookBean"%>
					...
					<div class="navbar-wrapper">
						...
						<div class="navbar-minimize">
							...
							<div class="collapse navbar-collapse justify-content-end">
									<h2 style="margin-left: 300px; color: purple" class="card-title">Library Management Sysytem</h2>
							</div>
						</div>
			</nav>
			<!-- End Navbar -->
								...
								<div class="card-body">
									...
									<div class="material-datatables">
										...
										<table id="datatables"
											...
											List<IssuedBookBean> book_list = BookManager.getAllIssuedBooksByUser(user.getEmail());
											
											for( IssuedBookBean bean : book_list){
												
											%>
											
											<tr>
											
													<td><%=  bean.getRequested_id() %></td>
													<td><%= bean.getBook_name() %></td>
													<td><%= bean.getUrl() %></td>
													<td><%= bean.getIssued_date() %></td>
													<td><%= bean.getDue_date()%></td>
													<td><%= bean.getUser_email() %></td>
