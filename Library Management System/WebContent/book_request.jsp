<%@page import="manager.BookRequestManager"%>
<%@page import="Beans.RequestBookBean"%>
			...
			<div class="sidebar-wrapper">
				...
				<div class="user">
					...
					<div class="user-info">
						<a data-toggle="collapse" href="#collapseExample" class="username">
							<span><b> <%=user.getFirstName()%> <%=user.getLastName()%></b><b
								class="caret"> </b> </span>
						</a>
						<div class="collapse" id="collapseExample">
							<ul class="nav">
								
								<li class="nav-item"><a class="nav-link" href="edit_profile.jsp"> <span
				...
				<ul class="nav">
					...
					<li class="nav-item "><a class="nav-link"
						href="dashboard.jsp"> <i class="material-icons">list</i>
							<p>Dashboard</p>
					</a></li>
					<li class="nav-item "><a class="nav-link"
						href="issued_books.jsp"> <i class="material-icons">list</i>
							<p>View Issued Books</p>
					</a></li>
					<li class="nav-item "><a class="nav-link"
						href="all_archive_books.jsp"> <i class="material-icons">list</i>
							<p>View All Archive Books</p>
					</a></li>
					<li class="nav-item "><a class="nav-link"
						href="book_request.jsp"> <i class="material-icons">list</i>
							<p>Submit Book Request</p>
					</a></li>
		...
		<div class="main-panel">
					...
					<div class="navbar-wrapper">
						...
						<div class="navbar-minimize">
							...
							<div class="collapse navbar-collapse justify-content-end">
								<h2 style="margin-left: 300px; color: purple" class="card-title">Library
									Management Sysytem</h2>
							</div>
						</div>
			</nav>
			<!-- End Navbar -->
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<form id="TypeValidation" class="form-horizontal" action="BookRequestServlet"
								method="">
								<div class="card ">
									...
									<div class="card-body ">
										...
										<div class="row">
											<label class="col-sm-2 col-form-label">Google/Amazon Book Page</label>
											<div class="col-sm-7">
												<div class="form-group">
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header card-header-primary card-header-icon">
										...
										<h4 class="card-title">List Requested Books</h4>
									</div>
									<div class="card-body">
										<div class="toolbar">
										...
										<div class="material-datatables">
											...
											List<RequestBookBean> request_list = BookRequestManager.getAllRequestsByUser((user.getEmail())) ;
												
													
											
											for(RequestBookBean bookrequest : request_list){
												
												%>
											
											<tr>
											
													<td><%= bookrequest.getBook_name() %></td>
													<td><%= bookrequest.getUrl()%></td>
													<td><%= bookrequest.getNote()%></td>
													<td><%= bookrequest.getUser()%></td>
