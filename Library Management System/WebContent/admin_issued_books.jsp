								...
								<div class="card-body">
									...
									<div class="material-datatables">
										...
										<table id="datatables"
											...
											<tbody>
											<%
											List<IssuedBookBean> book_list = BookManager.getAllIssuedBooks();
											...
											<tr>
													...
													<td class="td-actions text-right"><%= bean.getUser_email() %></td>
													<td class="td-actions"><a
														href="ReturnBookRequestServlet?request=<%=bean.getRequested_id()%>">
														Returned</a>
													</td>
