...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/pages/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Nov 2018 01:14:13 GMT -->
...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white" id="navigation-example">
    ...
    <div class="navbar-wrapper">
			...
			<a class="navbar-brand" href="#pablo">Admin Login </a>
		</div>
...
<div class="page-header login-page header-filter" filter-color="black" style="background-image: url('assets/img/login.jpg'); background-size: cover; background-position: top center;">
  ...
  <div class="container">
    <div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
      <form class="form" method="POST" action="AdminLoginServlet">
        <div class="card card-login card-hidden">
          ...
          <h5 style="margin-left: 80px; color: red; "><c:out value='${requestScope["fail"]}'/></h5> 
          <h5 style="margin-left: 80px; color: red; "><c:out value='${requestScope["succeess"]}'/></h5> 
...
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc --><script src="assets/js/material-dashboard.min40a0.js?v=2.0.2" type="text/javascript"></script>
