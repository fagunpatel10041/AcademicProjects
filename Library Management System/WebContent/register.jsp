...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/pages/login.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Nov 2018 01:14:13 GMT -->
...
<div class="page-header login-page header-filter" filter-color="black" style="background-image: url('assets/img/login.jpg'); background-size: cover; background-position: top center;">
  ...
  <div class="container">
    <div class="col-lg-4 col-md-6 col-md-6 ml-auto mr-auto">
      <form class="form" method="POST" action=RegistrationServlet>
          ...
          <div class="card-body ">
            ...
            <span class="bmd-form-group">
              <div class="input-group">
                ...
                <input type="password" name="pass" class="form-control" placeholder="Confirm Password..." required="required">
              </div>
            </span>
          </div>
