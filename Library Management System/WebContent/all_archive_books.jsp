					...
					<div class="navbar-wrapper">
						...
						<div class="navbar-minimize">
							...
							<div class="collapse navbar-collapse justify-content-end">
									<h2 style="margin-left: 350px; color: purple" class="card-title">Admin - Book Data</h2>
							</div>
						</div>
			</nav>
			<!-- End Navbar -->
								...
								<div class="card-body">
									...
									<div class="material-datatables">
										...
										<table id="datatables"
											...
											<tbody>
											<%
											List<IssuedBookBean> book_list = BookManager.getAllArchiveBooksByUser(user.getEmail());
											
											for(IssuedBookBean books : book_list){
												
											%>
											
											<tr>
											
													<td><%= books.getRequested_id()%></td>
													<td><%= books.getBook_name()%></td>
													<td><%= books.getUser_email() %></td>
													<td><%= books.getIssued_date()%></td>
													<td><%= books.getDue_date()%></td>
