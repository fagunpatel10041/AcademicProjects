						...
						<div class="collapse" id="collapseExample">
							<ul class="nav">
								...
								<li class="nav-item"><a class="nav-link"
									href="<c:url value = "LogoutServlet"/>"> <span
									...
									<div class="card-body">
										...
										<div class="material-datatables">
											<table id="datatables"
												...
												<tbody>
													<%
											List<RequestBookBean> request_list = BookRequestManager.getAllRequests() ;
												
													System.out.println(user.getEmail());
											
											for(RequestBookBean bookrequest : request_list){
												
												System.out.println(bookrequest.getBook_name());
												%>
											
											<tr>
													<td><%= bookrequest.getR_id() %>
													...
													<td class="td-actions"><a
														href="AcceptBookRequestServlet?request=<%=bookrequest.getR_id()%>">
														Accept Request</a>
													</td>
