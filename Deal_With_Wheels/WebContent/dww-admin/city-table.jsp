                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">City Table</h4> </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                            <div style="float: right;"> <a href="#"><button type="button" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#add-contact">Add New City</button></a></div>
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-striped">
                                        ...
                                        <tbody>
                                         <%
                                            List<CityBean> list = CityManager.getCityList();
                                            int counter4 = 0;
                                        ...
                                        %>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-info btn-outline btn-circle btn-sm m-r-20"><i class="ti-upload"></i></button>
