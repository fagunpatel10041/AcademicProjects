<%-- 
    Document   : index
    Created on : Nov 26, 2017, 11:50:52 PM
    Author     : fagun
--%>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2017 10:36:46 GMT -->
<head>
...
<body>
    ...
    <div class="global-wrap">
        ...
        <header id="main-header">
         ...
         <img class="origin round" src="img/amaze_300x300.jpg" alt="Image Alternative text" title="AMaze" /><%= user.getFname()%> <%= user.getLname()%></a>
                                    </li>
                        ...
                        <li><a href="success-payment.html">Pages</a>
                            <ul>
                                ...
                                <li><a href="login-register.html">Login/Register</a>
                                    <ul>
                                        <li><a href="varifyAccount.jsp">Full Page</a>
                                        </li>
                                        <li><a href="update_profile.jsp">Normal</a>
                                        </li>
                                    </ul>
                                </li>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2017 10:40:57 GMT -->
</html>
